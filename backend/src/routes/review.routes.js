...
import { reviewSchema, reviewUpdateSchema, reviewQuerySchema } from '../schemas/review.schema.js';

const router = express.Router();

router.get('/', cache(300), validateQuery(reviewQuerySchema), reviewController.getAll);

...
const SpicePowders = () => {
  ...
  const { cart } = useCart();
  const { products: spiceProducts } = useProducts("spices");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        className="
          relative text-black
          bg-gradient-to-b from-yellow-600 via-orange-500 to-white
          md:bg-gradient-to-r md:from-yellow-600 md:via-orange-500 md:to-orange-700
        "
      >
        <button
          onClick={() => navigate(-1)}
        ...
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          <p className="mx-auto text-sm max-w-2xl text-lg">
            Freshly ground spice powders crafted to bring authentic aroma and

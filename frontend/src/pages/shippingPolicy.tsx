    ...
    <div className="min-h-screen bg-background py-16 px-6">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="text-center text-muted-foreground mb-12">
          At Vivid Vitablends, every product is freshly prepared in small batches
          ...
          <CardContent className="space-y-8 p-8">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Since our products are handmade and preservative-free,
                  slight preparation time may be required.
                </li>
                <li>
                  Orders placed on weekends or holidays are processed
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Free shipping may be offered on selected orders or promotional periods.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>
                  Once shipped, tracking details will be shared via WhatsApp or SMS.
                </li>
                <li>
                  Please ensure your phone number is correct at checkout.
                </li>
              </ul>
            </div>
